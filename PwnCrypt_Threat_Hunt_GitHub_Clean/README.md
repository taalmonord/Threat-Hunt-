...
![Broad .ps1 search results across ta-zero-day](assets/01_ps1_broad_search_results.png)
...
![Payload creation evidence in DeviceFileEvents](assets/02_payload_creation_evidence.png)
...
![Process execution evidence in DeviceProcessEvents](assets/03_process_execution_evidence.png)
...
![First result in the impact query window: the pwncrypt.ps1 creation event](assets/04_impact_query_first_result.png)

![temp.csv created on Alex's desktop](assets/05_impact_temp_csv.png)

![5086_CompanyFinancials_pwncrypt.csv renamed into C:\Windows\Temp](assets/06_impact_companyfinancials.png)

![5107_ProjectList_pwncrypt.csv created on Alex's desktop](assets/07_impact_projectlist.png)

![2377_EmployeeRecords_pwncrypt.csv renamed into C:\Windows\Temp](assets/08_impact_employeerecords.png)

![Decryption-instructions ransom note created on Alex's desktop](assets/09_impact_ransom_note.png)
...
![MDE device isolation action for ta-zero-day](assets/10_mde_device_isolation.png)
